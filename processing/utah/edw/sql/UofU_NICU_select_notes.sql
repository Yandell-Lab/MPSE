with nicus as (
  ...
  AND nicu_unit_flg_dwid = 675863
  WHERE pat.pat_id = {{ PAT_ID }}
)

SELECT nicus.dw_pid, nicus.pat_id, 
...
WHERE RPT_TYPE_CD IN ('A&P Note', 'PROGRESS', 'PRG', 'H&P', 'Disch Summ', 'CONSULT', 'ADMHP', 'ECO', 'CD:175532290', 'DSUM', 'DISCH')
