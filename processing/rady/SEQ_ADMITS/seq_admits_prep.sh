...
in2csv -I -f csv ../../../data/rady_data/RADY_HPO_SEQ_ADMITS/Utah_Rady_CT_HPO_Manifest_16APR2020_DeIdentified.txt | \
...
csvjoin -I -c ResearchID --outer data_views/Utah_Rady_CT_HPO_Manifest_16APR2020_DeIdentified.csv seq_combined_list.csv | \
	csvcut -C Manual_HPO,ResearchID2 > data_views/rady_hpo_seq_admits_combined.csv

# recode years as days
grep years data_views/rady_hpo_seq_admits_combined.csv | \
    sed -re 's/ years//' | \
    awk -F, -v OFS=, '$2*=365' > years2days
...
csvsort -I -c ResearchID all_ages > data_views/rady_hpo_seq_admits_combined.csv
